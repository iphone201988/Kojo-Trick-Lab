...
@HiltViewModel
class UserProfileFragmentVM @Inject constructor(private val apiHelper: ApiHelper,) : BaseViewModel() {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            runCatching {
                ...
                if (response.isSuccessful) {
                    observeCommon.postValue(Resource.success("getUserProfile", response.body()))
                } else {
